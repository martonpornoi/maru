"""Dormant read-only person viewers under the exact admitted review purpose."""
...
from .programme_review_person_references import get_programme_review_person_reference
...
if TYPE_CHECKING:
    from .programme_person_references import ProgrammePersonReferenceView
...
def _page(
    ...
    def read() -> ProgrammePersonReferenceView:
        return get_programme_review_person_reference(
            request=scope,
            case_id=case_id,
    ...
    shell.update(
        ...
        title="Programme person reference",
        person_view=view,
        purpose=purpose,
        organization_id=scope.organization_id,
        edition_id=scope.edition_id,
    ...
    content = render_to_string(
        "applications/programme_review_person_reference.html", shell, request
    )
...
@never_cache
@require_GET
def programme_review_person_reference(
    request: HttpRequest,
    ...
    *,
    ...
    """View a retained person reference without granting another review role.
    ...
    try:
        ...
        return _secure(
            HttpResponse("This person reference is unavailable.", status=404)
        )
    except _UNAVAILABLE:
        return _secure(
