...
CAPABILITY_DEFINITIONS = (
    ...
    Capability(
        code="scheduling.view_change_notices",
        description="Read independently authorized exact Programme change notices.",
        maximum_scope=ScopeLevel.EDITION,
        delegable=True,
        sensitivity_ceiling=Sensitivity.RESTRICTED,
        field_ceiling=frozenset({"change_notices"}),
        obligations=frozenset({"audit_sensitive_read"}),
    ),
    Capability(
        code="scheduling.prepare_change_notices",
        description="Prepare one exact-source Programme change for one recipient.",
        maximum_scope=ScopeLevel.EDITION,
        delegable=True,
        sensitivity_ceiling=Sensitivity.RESTRICTED,
        obligations=frozenset({"reason", "audit"}),
    ...
    Capability(
        code="scheduling.review_change_notices",
        description="Independently approve or reject an exact Programme change notice.",
        maximum_scope=ScopeLevel.EDITION,
        delegable=True,
        sensitivity_ceiling=Sensitivity.RESTRICTED,
        obligations=frozenset({"reason", "audit"}),
    ...
    Capability(
        code="scheduling.handoff_change_notices",
        description="Record an explicit manual Programme notice handoff claim.",
        maximum_scope=ScopeLevel.EDITION,
        delegable=True,
        sensitivity_ceiling=Sensitivity.RESTRICTED,
        obligations=frozenset({"reason", "audit"}),
    ...
    Capability(
        code="scheduling.view_change_self",
        description="Read only one's own approved, currently eligible change notices.",
        maximum_scope=ScopeLevel.RESOURCE,
        persistable=False,
        allow_self=True,
        sensitivity_ceiling=Sensitivity.RESTRICTED,
        field_ceiling=frozenset({"own_change_notices"}),
        obligations=frozenset({"audit_sensitive_read"}),
    ),
    Capability(
        code="scheduling.acknowledge_change_self",
        description="Acknowledge an exact approved change only as its own recipient.",
        maximum_scope=ScopeLevel.RESOURCE,
        persistable=False,
        allow_self=True,
        sensitivity_ceiling=Sensitivity.RESTRICTED,
    ...
    Capability(
        ...
        delegable=True,
        sensitivity_ceiling=Sensitivity.RESTRICTED,
        field_ceiling=frozenset({"released_geometry"}),
        obligations=frozenset({"audit_sensitive_read"}),
    ),
    Capability(
        code="programme.view_operator_copy",
        description="Read exact released reviewed copy for an operator purpose.",
        maximum_scope=ScopeLevel.EDITION,
        delegable=True,
        sensitivity_ceiling=Sensitivity.RESTRICTED,
        field_ceiling=frozenset({"reviewed_copy"}),
        obligations=frozenset({"audit_sensitive_read"}),
    ),
    Capability(
        code="programme.view_operator_delivery",
        description="Read explicitly requested current operator delivery layers.",
        maximum_scope=ScopeLevel.EDITION,
        delegable=True,
        sensitivity_ceiling=Sensitivity.RESTRICTED,
        field_ceiling=frozenset({"technical", "accessibility", "media"}),
        obligations=frozenset({"audit_sensitive_read"}),
    ),
    Capability(
        code="venues.view_operator_wayfinding",
        description="Read current room membership and operator wayfinding.",
        maximum_scope=ScopeLevel.EDITION,
        delegable=True,
        sensitivity_ceiling=Sensitivity.RESTRICTED,
        field_ceiling=frozenset({"scope_links", "wayfinding"}),
        obligations=frozenset({"audit_sensitive_read"}),
    ),
    Capability(
        code="workforce.view_operator_staffing",
        description="Read Programme-linked operator work without a person roster.",
        maximum_scope=ScopeLevel.EDITION,
        delegable=True,
        sensitivity_ceiling=Sensitivity.RESTRICTED,
        field_ceiling=frozenset({"scope_links", "work_instructions", "coverage"}),
        obligations=frozenset({"audit_sensitive_read"}),
    ),
    Capability(
