...
class PersonalProgrammeTaskLink:
    ...
    url
        Currently resolved exact-edition destination without a selectable person.
    """
...
def personal_programme_task_links(
    *,
    ...
    current : str
        Closed proposals, hosting or timetable task to omit from its own links.
    ...
    -------
    tuple[PersonalProgrammeTaskLink, ...]
        At most two mounted fixed-label links. Denied, unavailable or shadowed
