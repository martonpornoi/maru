...
MARU_PROGRAMME_FILE_SCANNER = os.environ.get("MARU_PROGRAMME_FILE_SCANNER", "disabled")
MARU_PROGRAMME_FILE_SCANNER_HOST = os.environ.get(
    "MARU_PROGRAMME_FILE_SCANNER_HOST", ""
)
MARU_PROGRAMME_FILE_SCANNER_PORT = int(
    os.environ.get("MARU_PROGRAMME_FILE_SCANNER_PORT", "3310")
)
MARU_PROGRAMME_FILE_SCANNER_TIMEOUT_SECONDS = float(
    os.environ.get("MARU_PROGRAMME_FILE_SCANNER_TIMEOUT_SECONDS", "5")
)
...
MARU_APPLICATIONS_PROGRAMME_IMPORT_RETENTION_POLICY_JSON = os.environ.get(
