...
| Edition-aware sidebar context | UX-001 through UX-009, ADR 0008 | Preserved in the pre-reset `/admin/` shell, embedded Convention work, and specialist records; ADR 0030 leaves those pages unmounted. |
