...
an edition lock and a minimized required query audit. Its purpose-signed proof
contains only the selected person identifier and a digest binding actor, tenant,
